...
const AddContact = () => {
  ...
  const imagePicker = async e => {
    ...
    console.log( "pages => AddContact => imagePicker" )
  ...
  const addContact = async () => {
    ...
    console.log ( " pages => AddContact => addContact " )
  ...
  const updateContact = async () => {
    ...
    // try {
       ...
       console.log( " pages => AddContact => UpdateContacts " )
    ...
    try {
      firebase.database().ref ('contacts/' + contactToUpdateKey).set(
        {
          name, email, phoneNumber, address, picture: downloadUrl, star, dash, date
        }
      )
    } catch (error) {
      console.log(error)
      toast (" Ooppss...", {type: "error"})
    }
  ...
  const handleSubmit = e => {
    ...
    console.log( " AddContacts => handleSubmit " )
            ...
            <FormGroup check>
              ...
              <Label check>
                <Input
                  ...
                  checked={dash}
                />{" "}
                <span className="text-right">Mark as Recently Seen</span>
              </Label>
            </FormGroup>
            <Button
              type="submit"
