...
const Contact = ({ contact, contactKey }) => {
  ...
  const deleteContact = () => {
    ...
    console.log( " Components => Contact => deleteContact " )
  ...
  const updateImpContact = () => {
    ...
    console.log( "Componenet => Contact => updateImpContact" )
  ...
  const updateRecentContact = () => {
    //TODO: DONE update (star) contact, use contactKey

    console.log( "Componenet => Contact => updateRecentContact" )
  ...
  const updateContact = () => {
    ...
    console.log( "Component => Contact => updateContact" )    
  ...
  const viewSingleContact = contact => {
    ...
    console.log ( "Component => Contact => viewSingleContact" )
  ...
  return (
    <>
      <Row>
        ...
        className="d-flex justify-content-center align-items-center"
        >
        <div className="icon" onClick={() => updateRecentContact()}>
            {contact.dash ? (
              <MdCheckBox className=" text-primary" />
            ) : (
              <MdCheckBoxOutlineBlank className=" text-info" />
            )}
          </div>
        </Col>
        <Col
